        ...
        <div className="middle">
          ...
          <div className="exp_box">
            ...
            <div className="explain">
              <p>
                프론트엔드 개발자는 사용자가 서비스를 빠르고 편리하게 이용할 수
                있도록 웹사이트나 어플리케이션 등의 사용자 인터페이스(UI)를
                구현하는 일을 합니다. <br />
                이 밖에도 시장 점유율을 높이기 위해 다양한 운영 체제, 브라우저에서
    ...
    return (
      ...
      <div className="main">
        ...
        <div className="middle">
          <div className="photo_guard">
            <div className="only_photo">
              <img className="photo" src="" alt="Design.png" />{" "}
              {/* 디자인 사진 */}
            </div>
            {resultData.map((data, index) => (
              <div key={index} className="bar-container">
    ...
    return (
      ...
      <div className="main">
        ...
        <div className="middle">
          <div className="photo_guard">
            <div className="only_photo">
              <img className="photo" src="" alt="Back.png" />{" "}
              {/* 백엔드 사진 */}
            </div>
            {resultData.map((data, index) => (
              <div key={index} className="bar-container">
          ...
          <div className="exp_box">
            ...
            <div className="explain">
              <p>
                ...
                OS관리도 담당합니다. <br></br>
                주로 자바(JAVA)언어를 사용하며 사용자의 요구사항을 데이터화하여
                요구사항에 맞게 가공한 뒤 데이터를 Front-end로 되돌려주는 역할을
                합니다.
                <br></br>
                <br></br>
                사용언어:<br></br>
