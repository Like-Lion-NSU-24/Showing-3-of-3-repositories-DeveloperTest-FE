...
const Result = (props) => {
  ...
  const [resultData, setResultData] = useState([
    { label: "Front_end", percentage: 30, color: "#FF6384" },
    { label: "Design", percentage: 30, color: "#36A2EB" },
    { label: "Back_end", percentage: 40, color: "#FFCE56" },
  ]);
                ...
                {resultData.map((data, index) => (
                  <div key={index} className="bar-container">
                    ...
                    <div className="bar-wrapper">
                      <div
                        className="bar-front"
                        style={{ width: `${data.percentage / 3}%` }}
                      >
                        <p className="bar-font">Front_end</p>
                      </div>
                      <div
                        className="bar-design"
                        style={{ width: `${data.percentage / 3}%` }}
                      >
                        <p>Design</p>
                      </div>
            ...
            <div className="exp_box">
              ...
              <div className="explain">
                <p>
                  ...
                  수 있도록 웹사이트나 어플리케이션 등의 사용자 인터페이스(UI)를
                  구현하는 일을 합니다. <br></br> 이 밖에도 시장 점유율을 높이기
                  위해 다양한 운영 체제, 브라우저에서 모두 작동되는 사이트를
                  만들거나, 각각의 운영체제, 브라우저에 최적화된 웹사이트나 앱을
                  만드는 일을 합니다.<br></br> <br></br>
